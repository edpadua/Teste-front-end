...
import { Container, TextBox, Title, SubTitle, Text } from "./styles";
...
function Sobre() {
  ...
  return (
    ...
    <Header title={"Quem Somos"} line={"A maior rede de tratamento pokémon"}/>
    <Container>
     <TextBox>
      <Title>O Centro Pokémon</Title>
      ...
      <SubTitle>Uma tradição de mais de 20 anos</SubTitle>
      <Text>
      ...
      <SubTitle>O melhor para seu pokémon</SubTitle>
      <Text>
      ...
      <SubTitle>Alta Tecnologia</SubTitle>
      <Text>
